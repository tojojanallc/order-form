...
<Link href="/admin/shipping" className="bg-white p-6 rounded-[32px] border border-orange-100 shadow-sm flex items-center justify-between hover:shadow-md transition-all group">
  ...
  <p className="text-xs text-gray-400 font-medium mt-1">Launch a new kiosk.</p>
            ...
            <Link href="/admin/sport-templates" className="bg-white p-6 rounded-[32px] border border-gray-200 hover:border-indigo-300 transition-all group">
                <div className="w-10 h-10 bg-indigo-50 rounded-full flex items-center justify-center mb-4 text-xl">🏅</div>
                <h4 className="font-black text-slate-900">Sport Templates</h4>
                <p className="text-xs text-gray-400 font-medium mt-1">Manage logo add-ons by sport.</p>
            </Link>

            <Link href="/admin/customers" className="bg-white p-6 rounded-[32px] border border-gray-200 hover:border-blue-300 transition-all group">
                <div className="w-10 h-10 bg-blue-50 rounded-full flex items-center justify-center mb-4 text-xl">👥</div>
                <h4 className="font-black text-slate-900">Customer History</h4>
                <p className="text-xs text-gray-400 font-medium mt-1">Cross-event profiles & order history.</p>
            </Link>

            <Link href="/admin/analytics" className="bg-white p-6 rounded-[32px] border border-gray-200 hover:border-pink-300 transition-all group">
                <div className="w-10 h-10 bg-pink-50 rounded-full flex items-center justify-center mb-4 text-xl">📊</div>
                <h4 className="font-black text-slate-900">Product Performance</h4>
            ...
            <Link href="/admin/daily-rec" className="bg-white p-6 rounded-[32px] border border-gray-200 hover:border-blue-300 transition-all group">
                <div className="w-10 h-10 bg-blue-50 rounded-full flex items-center justify-center mb-4 text-xl">📊</div>
                <h4 className="font-black text-slate-900">Daily Sales Rec</h4>
                <p className="text-xs text-gray-400 font-medium mt-1">Revenue, COGS, staff cost by date.</p>
            </Link>

            <Link href="/admin/purchasing/ss" className="bg-white p-6 rounded-[32px] border border-gray-200 hover:border-orange-300 transition-all group">
                <div className="w-10 h-10 bg-orange-50 rounded-full flex items-center justify-center mb-4 text-xl">🛒</div>
                <h4 className="font-black text-slate-900">S&S Order</h4>
                <p className="text-xs text-gray-400 font-medium mt-1">Search S&S catalog, build & save PO.</p>
            </Link>

            <Link href="/admin/order-helper" className="bg-white p-6 rounded-[32px] border border-gray-200 hover:border-indigo-300 transition-all group">
                <div className="w-10 h-10 bg-indigo-50 rounded-full flex items-center justify-center mb-4 text-xl">📦</div>
                <h4 className="font-black text-slate-900">Order Helper</h4>
                <p className="text-xs text-gray-400 font-medium mt-1">Blank quantity recommendations from sales history.</p>
            </Link>
