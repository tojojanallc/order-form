...
export default function OrderForm() {
  ...
  // --- FIXED: SWEATSHIRT PLACEMENT BUG ---
  // Changed from "sweat" to "sweatpant" so sweatshirts correctly stay as Tops
  ...
  // --- RESTORED EXACT ORIGINAL URL & CACHE LOGIC ---
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (productData) {
          // Removes exact database row duplicates, but preserves distinct color items
          const uniqueProductsMap = new Map();
          productData.forEach(p => uniqueProductsMap.set(p.id, p));
