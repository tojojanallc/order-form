...
export default function OrderForm() {
  ...
  const isBottomSelected = (() => {
      ...
      if (t === 'bottom' || n.includes('jogger') || n.includes('pant') || n.includes('short') || id.includes('jogger') || id.includes('pant') || id.includes('short')) {
          return true;
      }
      return false;
  })();
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
        ...
        if (querySlug) {
            ...
            if (lastSegment && lastSegment !== 'kiosk') {
